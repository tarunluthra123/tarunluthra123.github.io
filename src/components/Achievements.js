                ...
                <div className="container">
                    <Fade bottom>
                        <div className="row p-2 m-2">
                            <div className="col-2 col-sm-2 col-md-1 sectionImage">
                                <a
                                    href={
                                        "https://www.facebook.com/DUCS.Sankalan/"
                                    }
                                    target={"_blank"}
                            ...
                            <section className="col col-sm col-md achievementSection">
                                ...
                                <br />
                                <div className="achievementOrganisation">
                                    <i>
                                        Delhi University, Computer Science Dept.
                                    </i>
                                </div>
                            </section>
                        ...
                        <div className="row p-2 m-2">
                            ...
                            <section className="col col-sm col-md achievementSection">
                                ...
                                <section style={{ fontSize: "90%" }}>
                                    Received Letter of Recommendation for
                                    exemplary volunteer work at Umeed NGO.
                                </section>
                            </section>
                            <section className="col-2 col-sm-2 col-md-2">
                                2019
                    ...
                    <Fade bottom>
                        <div className="row p-2 m-2">
                            <div className="col-2 col-sm-2 col-md-1 sectionImage">
                                <a
                                    href="https://www.youracclaim.com/badges/bee7f14c-81d7-470d-82d7-eeb33380db18/linked_in_profile"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                    <img
